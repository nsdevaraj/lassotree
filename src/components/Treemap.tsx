...
export const Treemap: React.FC<TreemapProps> = ({
  ...
  const setupLassoSelection = (paper: Snap.Paper) => {
    let isDrawing = false;
  ...
  // Render treemap nodes and titles
  const renderTreemap = (
    paper: Snap.Paper,
    tree: any
  ) => {
    tree.each((node: any) => {
      ...
      // Add a unique identifier to the group
      ...
      group.click((e: MouseEvent) => {
        ...
        // Set opacity for the group and all its children
        group.attr({ opacity: newOpacity });
        
        // Select and update all rect and text elements within the group
